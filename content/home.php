            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                        ...
                        <img class="img-fluid" src="assets/img/portfolio/bengkel.png" alt="..." />
                    </div>
                </div>
                <!-- Portfolio Item 2-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
                        ...
                        <img class="img-fluid" src="assets/img/portfolio/perpus.png" alt="..." />
                    </div>
                </div>
                <!-- Portfolio Item 3-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal3">
                        ...
                        <img class="img-fluid" src="assets/img/portfolio/ecommerce.png" alt="..." />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 ms-auto">
                    <p class="lead">Sebagai seorang yang suka mendalami banyak hal, saya memiliki berbagai minat yang
                        luas,
                        mulai dari ilmu pengetahuan dan teknologi hingga seni dan desain. Saya percaya bahwa kombinasi
                        dari
                        ketertarikan ini memberi saya wawasan yang unik dan kemampuan untuk memahami berbagai
                        perspektif.

                        Dalam hal pendidikan, saya telah mengambil pendekatan yang holistik, belajar di berbagai bidang
                        untuk mendapatkan pemahaman yang lebih dalam tentang dunia di sekitar saya. Saya juga aktif
                        dalam
                        berbagai kegiatan di luar kurikulum, seperti organisasi mahasiswa dan proyek-proyek sukarela,
                        yang
                        membantu saya mengembangkan keterampilan kepemimpinan dan kerjasama tim.

                        Secara profesional, saya telah memiliki pengalaman dalam beberapa proyek yang menarik, yang
                        meliputi
                        ...
                        Di masa depan, saya berharap dapat terus belajar dan tumbuh, serta berkontribusi dalam bidang
                        yang
